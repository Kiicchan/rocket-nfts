export function Header() {
    return (
        <header className="fixed top-0 left-0 right-0 container mx-auto py-14 flex items-center justify-between">
            ...
            <button className="w-56 h-12 bg-white text-black font-bold text-base center gap-4 active:bg-logo hover:opacity-90">
                <img src="/src/assets/icons/logo_MetaMask.svg" alt="Fox" />
                Conectar Carteira
            </button>
        </header>
    )
