        ...
        <div className="border-b border-subtitle">
            <div className="grid grid-cols-6 grid-rows-[1fr_fit-content] sm:grid-cols-1 sm:mt-5">
                <div className="col-span-1 row-span-2 flex flex-col justify-center gap-10 border-r border-subtitle sm:flex-row sm:border-r-0">
                    <p className="text-5xl text-center font-semibold lg:text-3xl">10K+ <small className="block text-xl text-subtitle lg:text-base">Artes</small></p>
                    <p className="text-5xl text-center font-semibold lg:text-3xl">200+ <small className="block text-xl text-subtitle lg:text-base">Vendas</small></p>
                    <p className="text-5xl text-center font-semibold lg:text-3xl">20 <small className="block text-xl text-subtitle lg:text-base">Artistas</small></p>
                </div>
                <div className="col-span-5 row-span-1 flex items-center p-10 gap-10 lg:p-5 lg:gap-5 sm:flex-col">
                    <div className="text-lg lg:text-base sm:text-sm sm:text-justify">
                        <blockquote>
